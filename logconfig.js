...
exports.use = function(app) {  
    ...
    //app.use(log4js.connectLogger(logInfo, {level:log4js.levels.DEBUG, format:':method :url'}));  
	// app.use(log4js.connectLogger(logInfo,{level:log4js.levels.ERROR, format:':method :url'})); 
}  
